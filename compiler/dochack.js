/* Generated by the Nim Compiler v0.1.0-dev.20056 */
var framePtr = null;
var excHandler = 0;
...
var NTI33555084 = {size: 0, kind: 17, base: null, node: null, finalizer: null};
var NTI33555166 = {size: 0, kind: 22, base: null, node: null, finalizer: null};
...
NTI33555165.base = NTI33555113;
NTI33555166.base = NTI33555113;
var NNI33555113 = {kind: 2, len: 5, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "parent", len: 0, typ: NTI33555165, name: "parent", sons: null}, 
{kind: 1, offset: "name", len: 0, typ: NTI33554440, name: "name", sons: null}, 
{kind: 1, offset: "message", len: 0, typ: NTI33554439, name: "msg", sons: null}, 
{kind: 1, offset: "trace", len: 0, typ: NTI33554439, name: "trace", sons: null}, 
{kind: 1, offset: "up", len: 0, typ: NTI33555166, name: "up", sons: null}]};
NTI33555113.node = NNI33555113;
var NNI33555084 = {kind: 2, len: 0, offset: 0, typ: null, name: null, sons: []};
NTI33555084.node = NNI33555084;
NTI33555113.base = NTI33555084;
NTI33555114.base = NTI33555113;
NTI33555121.base = NTI33555114;
NTI33555123.base = NTI33555121;
var NNI33555131 = {kind: 2, len: 0, offset: 0, typ: null, name: null, sons: []};
NTI33555131.node = NNI33555131;
NTI33555131.base = NTI33555114;
var NNI33555129 = {kind: 2, len: 0, offset: 0, typ: null, name: null, sons: []};
NTI33555129.node = NNI33555129;
NTI33555129.base = NTI33555114;
...
function makeNimstrLit(c_33556800) {
      var result = [];
  for (var i = 0; i < c_33556800.length; ++i) {
    result[i] = c_33556800.charCodeAt(i);
  }
  return result;
...
function toJSStr(s_33556806) {
                    var Temporary5;
            var Temporary7;

  var result_33556807 = null;

    var res_33556841 = newSeq_33556824((s_33556806).length);
    var i_33556842 = 0;
    var j_33556843 = 0;
    Label1: do {
        Label2: while (true) {
        if (!(i_33556842 < (s_33556806).length)) break Label2;
          var c_33556844 = s_33556806[i_33556842];
          if ((c_33556844 < 128)) {
          res_33556841[j_33556843] = String.fromCharCode(c_33556844);
          i_33556842 += 1;
          }
          else {
            var helper_33556856 = newSeq_33556824(0);
            Label3: do {
                Label4: while (true) {
                if (!true) break Label4;
                  var code_33556857 = c_33556844.toString(16);
                  if ((((code_33556857) == null ? 0 : (code_33556857).length) == 1)) {
                  helper_33556856.push("%0");;
                  }
                  else {
                  helper_33556856.push("%");;
                  }
                  
                  helper_33556856.push(code_33556857);;
                  i_33556842 += 1;
                    if (((s_33556806).length <= i_33556842)) Temporary5 = true; else {                      Temporary5 = (s_33556806[i_33556842] < 128);                    }                  if (Temporary5) {
                  break Label3;
                  }
                  
                  c_33556844 = s_33556806[i_33556842];
                }
            } while (false);
++excHandler;
            Temporary7 = framePtr;
            try {
            res_33556841[j_33556843] = decodeURIComponent(helper_33556856.join(""));
--excHandler;
} catch (EXCEPTION) {
 ...
 --excHandler;
            framePtr = Temporary7;
            res_33556841[j_33556843] = helper_33556856.join("");
    ...
    if (res_33556841.length < j_33556843) { for (var i = res_33556841.length ; i < j_33556843 ; ++i) res_33556841.push(null); }
               else { res_33556841.length = j_33556843; };
    result_33556807 = res_33556841.join("");

  return result_33556807;

}

function raiseException(e_33556666, ename_33556667) {
    e_33556666.name = ename_33556667;
    if ((excHandler == 0)) {
    unhandledException(e_33556666);
    }
...
function addInt(a_33556939, b_33556940) {
...
function mnewString(len_33556892) {
        return new Array(len_33556892);
...
function chckIndx(i_33557183, a_33557184, b_33557185) {
  ...
  BeforeRet: do {
      if (!(a_33557184 <= i_33557183)) Temporary1 = false; else {        Temporary1 = (i_33557183 <= b_33557185);      }    if (Temporary1) {
...
function subInt(a_33556943, b_33556944) {
...
function mulInt(a_33556947, b_33556948) {
...
function nimMax(a_33556997, b_33556998) {
    var Temporary1;

  var result_33556999 = 0;

  BeforeRet: do {
    if ((b_33556998 <= a_33556997)) {
...
function nimMin(a_33556993, b_33556994) {
    var Temporary1;

  var result_33556995 = 0;

  BeforeRet: do {
    if ((a_33556993 <= b_33556994)) {
...
function addChar(x_33557254, c_33557255) {
    x_33557254.push(c_33557255);
...
function newSeq_33556824(len_33556826) {
  var result_33556827 = [];

    result_33556827 = new Array(len_33556826); for (var i = 0 ; i < len_33556826 ; ++i) { result_33556827[i] = null; }
  return result_33556827;

}

function unhandledException(e_33556662) {
    var buf_33556663 = [[]];
    if (!(((e_33556662.message).length == 0))) {
    buf_33556663[0].push.apply(buf_33556663[0], makeNimstrLit("Error: unhandled exception: "));;
    buf_33556663[0].push.apply(buf_33556663[0], e_33556662.message);;
    }
    else {
    buf_33556663[0].push.apply(buf_33556663[0], makeNimstrLit("Error: unhandled exception"));;
    }
    
    buf_33556663[0].push.apply(buf_33556663[0], makeNimstrLit(" ["));;
    add_33556418(buf_33556663, 0, e_33556662.name);
    buf_33556663[0].push.apply(buf_33556663[0], makeNimstrLit("]\x0A"));;
...
function raiseOverflow() {
    raiseException({message: makeNimstrLit("over- or underflow"), parent: null, m_type: NTI33555123, name: null, trace: [], up: null}, "OverflowDefect");

  
}

function checkOverflowInt(a_33556937) {
        if (a_33556937 > 2147483647 || a_33556937 < -2147483648) raiseOverflow();
...
function raiseRangeError() {
    raiseException({message: makeNimstrLit("value out of range"), parent: null, m_type: NTI33555131, name: null, trace: [], up: null}, "RangeDefect");
...
function raiseIndexError(i_33556753, a_33556754, b_33556755) {
    ...
    raiseException({message: nimCopy(null, Temporary1, NTI33554439), parent: null, m_type: NTI33555129, name: null, trace: [], up: null}, "IndexDefect");
...
function sysFatal_218103842(message_218103845) {
    raiseException({message: nimCopy(null, message_218103845, NTI33554439), m_type: NTI33555125, parent: null, name: null, trace: [], up: null}, "AssertionDefect");
