...
const
  ...
  ArgumentListNodes* = {mnkCall, mnkMagic, mnkRegion, mnkConstr, mnkObjConstr,
                        mnkRaise, mnkAsgn, mnkFastAsgn, mnkInit, mnkSwitch} +
                       DefNodes
    ## Nodes that may be preceded by argument nodes.

  ArgumentListRequired* = {mnkCall, mnkFastAsgn, mnkAsgn, mnkInit, mnkSwitch, mnkAsm, mnkEmit}
    ## Nodes for which a preceding argument list is required.
...
const
  ...
  ImplicitMaterialize* = {mnkProc, mnkLiteral, mnkType, mnkConst, mnkAddr, mnkView,
                          mnkConv, mnkStdConv, mnkCast, mnkMagic, mnkCall,
                          mnkObjConstr, mnkConstr}
    ## Operations that implicitly materialize a *value*.

  RawExpressions* = {mnkLocal, mnkTemp, mnkParam, mnkGlobal, mnkPath, mnkDeref,
                     mnkDerefView} + ArgumentNodes
    ## Nodes that cannot be used in a value-expecting context directly.
    ## The values they represent have to be materialized first.

  StmtNodes* = {mnkScope, mnkRepeat, mnkTry, mnkBlock, mnkBreak, mnkReturn,
                mnkRaise, mnkDrop, mnkPNode, mnkIf, mnkCase, mnkRegion,
                mnkFastAsgn, mnkAsgn, mnkInit, mnkSwitch, mnkEmit, mnkAsm} + DefNodes
...
func `==`*(a, b: OpValue): bool {.borrow, inline.}
